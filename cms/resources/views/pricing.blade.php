      ...
      <div class="container">
         ...
         <div class="row pricing-f-b">
            <div class="col-md-4 col-sm-4 wow fadeIn" data-wow-delay="0.2s">
               <div class="feature">
                  <div class="feature_icon">
                     <img src="{{url('assets/images/pricing_icon_1.png')}}" alt="">
                  </div>
                  <h3>Logo &amp; branding</h3>
            ...
            <div class="col-md-4 col-sm-4 wow fadeIn" data-wow-delay="0.4s">
               <div class="feature">
                  <div class="feature_icon">
                     <img src="{{url('assets/images/pricing_icon_2.png')}}" alt="">
                  </div>
            ...
            <div class="col-md-4 col-sm-4 wow fadeIn" data-wow-delay="0.6s">
               <div class="feature">
                  <div class="feature_icon">
                     <img src="{{url('assets/images/pricing_icon_3.png')}}" alt="">
                  </div>
                  <h3>Search</h3>
                  <p class="feature_text">The wise man therefore always holds in these matters to this principle of selection:
                     he rejects pleasures to secure other greater pleasures, or else he endures pains
            ...
            <div class="col-md-4 col-sm-4 wow fadeIn" data-wow-delay="0.2s">
               <div class="feature">
                  <div class="feature_icon">
                     <img src="{{url('assets/images/pricing_icon_4.png')}}" alt="">
                  </div>
                  <h3>Analytics</h3>
                  <p class="feature_text">The wise man therefore always holds in these matters to this principle of selection:
                     he rejects pleasures to secure other greater pleasures, or else he endures pains
            ...
            <div class="col-md-4 col-sm-4 wow fadeIn" data-wow-delay="0.4s">
               <div class="feature">
                  <div class="feature_icon">
                     <img src="{{url('assets/images/pricing_icon_5.png')}}" alt="">
                  </div>
            ...
            <div class="col-md-4 col-sm-4 wow fadeIn" data-wow-delay="0.6s">
               <div class="feature">
                  <div class="feature_icon">
                     <img src="{{url('assets/images/pricing_icon_6.png')}}" alt="">
                  </div>
            ...
            <div class="col-md-4 col-sm-4 wow fadeIn" data-wow-delay="0.2s">
               <div class="feature">
                  <div class="feature_icon">
                     <img src="{{url('assets/images/pricing_icon_7.png')}}" alt="">
                  </div>
            ...
            <div class="col-md-4 col-sm-4 wow fadeIn" data-wow-delay="0.4s">
               <div class="feature">
                  <div class="feature_icon">
                     <img src="{{url('assets/images/pricing_icon_8.png')}}" alt="">
                  </div>
            ...
            <div class="col-md-4 col-sm-4 wow fadeIn" data-wow-delay="0.6s">
               <div class="feature">
                  <div class="feature_icon">
                     <img src="{{url('assets/images/pricing_icon_9.png')}}" alt="">
                  </div>
                  <h3>Support </h3>
                  <p class="feature_text">The wise man therefore always holds in these matters to this principle of selection:
                     he rejects pleasures to secure other greater pleasures, or else he endures pains
