         ...
         <div class="row">
            <div class="col-lg-8 col-lg-offset-2">
               ...
               <div class="about-icons row">
                  <div class="col-xs-4 wow fadeIn" data-wow-delay="0.0s"><img src="{{url('assets/images/about-icon-1.png')}}" alt="" /></div>
                  <div class="col-xs-4 wow fadeIn" data-wow-delay="0.2s"><img src="{{url('assets/images/about-icon-2.png')}}" alt="" /></div>
                  <div class="col-xs-4 wow fadeIn" data-wow-delay="0.4s"><img src="{{url('assets/images/about-icon-3.png')}}" alt="" /></div>
               </div>
            </div>
         </div>
      </div>
         ...
         <div class="row">
            <div class="col-lg-8 col-lg-offset-2">
               <div class="does-box">
                  ...
                  <img class="wow fadeIn" src="{{url('assets/images/mac-about.png')}}" alt="" />
               </div>
            </div>
         </div>
      </div>
      ...
      <div class="container">
         <div class="row">
            ...
            <div class="col-lg-8 col-lg-offset-2 wow fadeIn" style="margin-bottom:15px;" data-wow-delay="0.2s">
               <img class="img-responsive" src="{{url('assets/images/lag-60.png')}}" alt="" />
            </div>
            <div class="col-lg-8 col-lg-offset-2">
