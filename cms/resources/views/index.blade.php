         ...
         <div class="row clearfix">
            <div class="col-lg-3 col-sm-6 col-md-3">
               <a href="productpage">
                  <div class="box-img">
                     <h4>Product</h4>
                     <img src="{{url('assets/images/product/1.png')}}" alt="" />
                  </div>
               </a>
            </div>
            <div class="col-lg-3 col-sm-6 col-md-3">
               <a href="productpage">
                  <div class="box-img">
                     <h4>Product</h4>
                     <img src="{{url('assets/images/product/2.png')}}" alt="" />
                  </div>
               </a>
            </div>
            <div class="col-lg-3 col-sm-6 col-md-3">
               <a href="productpage">
                  <div class="box-img">
                     <h4>Product</h4>
                     <img src="{{url('assets/images/product/4.png')}}" alt="" />
                  </div>
               </a>
            </div>
            <div class="col-lg-3 col-sm-6 col-md-3">
               <a href="productpage">
                  <div class="box-img">
                     <h4>Product</h4>
                     <img src="{{url('assets/images/product/5.png')}}" alt="" />
                  </div>
               </a>
            </div>
            <div class="col-lg-3 col-sm-6 col-md-3">
               <a href="productpage">
                  <div class="box-img">
                     <h4>Product</h4>
                     <img src="{{url('assets/images/product/10.png')}}" alt="" />
                  </div>
               </a>
            </div>
            <div class="col-lg-3 col-sm-6 col-md-3">
               <a href="productpage">
                  <div class="box-img">
                     <h4>Product</h4>
                     <img src="{{url('assets/images/product/11.png')}}" alt="" />
                  </div>
               </a>
            </div>
            <div class="col-lg-3 col-sm-6 col-md-3">
               <a href="productpage">
                  <div class="box-img">
                     <h4>Product</h4>
                     <img src="{{url('assets/images/product/12.png')}}" alt="" />
                  </div>
               </a>
            </div>
            <div class="col-lg-3 col-sm-6 col-md-3">
   ...
   <div class="container">
      <div class="row panel-row">
         <div class="col-md-4 col-sm-6 wow fadeIn" data-wow-delay="0.0s">
            <div class="panel panel-default">
               <div class="panel-body">
                  <img src="{{url('assets/images/xpann-icon.jpg')}}" class="icon-small" alt="">
         ...
         <div class="col-md-4 col-sm-6 wow fadeIn" data-wow-delay="0.2s">
            <div class="panel panel-default">
               <div class="panel-body">
                  <img src="{{url('assets/images/create-icon.jpg')}}" class="icon-small" alt="">
         ...
         <div class="col-md-4 col-sm-6 wow fadeIn hidden-sm" data-wow-delay="0.4s">
            <div class="panel panel-default">
               <div class="panel-body">
                  <img src="{{url('assets/images/get-icon.jpg')}}" class="icon-small" alt="">
                  <h4>Get inspired</h4>
                  <p>Grow easily with chamb. Create free account.
                     We help expanding your business easily.
                  </p>
      ...
      <div class="row">
         <div class="col-md-6 col-sm-6 wow fadeIn" data-wow-delay="0.2s">
            <div class="exciting_box f_pd">
               <img src="{{url('assets/images/exciting_img-01.jpg')}}" class="icon-small" alt="" />
         ...
         <div class="col-md-6 col-sm-6 wow fadeIn" data-wow-delay="0.4s">
            <div class="exciting_box l_pd">
               <img src="{{url('assets/images/exciting_img-02.jpg')}}" class="icon-small" alt="" />
...
<div class="start-free-box">
   <div class="container">
      ...
      <div class="row">
         <div class="main-start-box">
            <div class="bg_img_left"><img src="{{url('assets/images/bg_img1.png')}}" alt="#" /></div>
            <div class="container">
               <div class="buyer-box clearfix">
                  <div class="col-md-6 col-sm-6 wow fadeIn" data-wow-delay="0.2s">
                     <div class="left-buyer">
                        <img class="img-responsive" src="{{url('assets/images/creat_pro.png')}}" alt="#" />
                     </div>
                  </div>
                  <div class="col-md-6 col-sm-6 wow fadeIn" data-wow-delay="0.4s">
      ...
      <div class="row">
         <div class="bg_img_right"><img src="{{url('assets/images/bg_img1.png')}}" alt="#" /></div>
         <div class="main-start-box">
            <div class="container">
               <div class="supplier clearfix">
                  ...
                  <div class="col-md-7 col-sm-6">
                     <div class="right-supplier">
                        <img class="img-responsive" src="{{url('assets/images/supplier-pc-img.png')}}" alt="#" />
                     </div>
                  </div>
               </div>
            </div>
