            ...
            <div class="right-works-box">
               <div class="small-box wow fadeIn" data-wow-delay="0.2s">
                  ...
                  <div class="how-dit-right">
                     <div class="dit-img">
                        <img class="img-responsive" src="{{url('assets/images/works-icon-01.png')}}" alt="" />
                     </div>
                     <h3>Sign up</h3>
               ...
               <div class="searching-box wow fadeIn" data-wow-delay="0.4s">
                  ...
                  <div class="how-dit-right">
                     <div class="dit-img">
                        <img class="img-responsive" src="{{url('assets/images/works-icon-02.png')}}" alt="" />
                     </div>
                     <h3>Search</h3>
               ...
               <div class="sellers-box wow fadeIn" data-wow-delay="0.6s">
                  ...
                  <div class="how-dit-right">
                     <div class="dit-img">
                        <img class="img-responsive" src="{{url('assets/images/works-icon-03.png')}}" alt="" />
                     </div>
                     <h3>Contact & buy</h3>
      ...
      <div class="row">
         <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="sys-box-left-b wow fadeIn" data-wow-delay="0.2s">
               <img src="{{url('assets/images/how-is-works-img-02.jpg')}}" alt="" />
            </div>
         </div>
         <div class="col-md-6 col-sm-6 col-xs-12">
      ...
      <div class="row">
         ...
         <div class="col-md-7 col-sm-6 col-xs-12">
            <div class="sys-box-right-c wow fadeIn" data-wow-delay="0.4s">
               <img src="{{url('assets/images/how-is-works-img-03.png')}}" alt="" />
            </div>
         </div>
      </div>
   </div>
      ...
      <div class="row">
         ...
         <div class="col-md-4 col-sm-6 col-xs-12 wow fadeIn" data-wow-delay="0.2s">
            <div class="benenfit-box">
               <div class="icon-b">
                  <img src="{{url('assets/images/icon-b1.png')}}" alt="" />
               </div>
         ...
         <div class="col-md-4 col-sm-6 col-xs-12 wow fadeIn" data-wow-delay="0.4s">
            <div class="benenfit-box">
               <div class="icon-b">
                  <img src="{{url('assets/images/icon-b2.png')}}" alt="" />
               </div>
         ...
         <div class="col-md-4 col-sm-6 col-xs-12 wow fadeIn" data-wow-delay="0.6s">
            <div class="benenfit-box">
               <div class="icon-b">
                  <img src="{{url('assets/images/icon-b3.png')}}" alt="" />
               </div>
         ...
         <div class="col-md-4 col-sm-6 col-xs-12 wow fadeIn" data-wow-delay="0.2s">
            <div class="benenfit-box">
               <div class="icon-b">
                  <img src="{{url('assets/images/icon-b4.png')}}" alt="" />
               </div>
         ...
         <div class="col-md-4 col-sm-6 col-xs-12 wow fadeIn" data-wow-delay="0.4s">
            <div class="benenfit-box">
               <div class="icon-b">
                  <img src="{{url('assets/images/icon-b5.png')}}" alt="" />
               </div>
               <h3>Support</h3>
               <p>On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms
                  of pleasure of the moment, so blinded by desire, that they cannot foresee the pain and trouble that are bound.
